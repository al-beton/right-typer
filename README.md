...
- Missing capture timestamps block practice. Once practice starts, a press with no hands in view stays unknown but does not block matching text. Setup repair remains available. Attribution accuracy on real hardware is unmeasured; the rule is chosen for simplicity and coverage, not proven precision.
