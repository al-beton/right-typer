...
- TypeScript and 71 deterministic tests: full 49-word synthetic passage, all 28 exercised character keys, both thumbs, intentional wrong fingers on both hands/rows, nearest-frame selection with one-sided and out-of-order frames, handless frames skipped, one hand, low handedness score, far fingertips, same-label hands relabelled by position, swap, no-hands unknowns, in-flight waiting, deadlines, attempt ownership, erased mistakes, pause/retry, WPM and storage failure recovery.
