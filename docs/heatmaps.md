...
Rendered fixtures at application source `28aa47b`: [response with 1,800 ms](images/heatmaps/response-synthetic.png), [Space detail](images/heatmaps/space-detail-synthetic.png), [custom profile at 390px](images/heatmaps/custom-390-synthetic.png). These are synthetic UI captures, with no personal camera data.
